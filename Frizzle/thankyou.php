...
<body>
	<div id="page"> <p style="color:black">Hey, <?php echo $_SESSION['username']; ?>! Do you want to <a href="logout.php">Logout</a> ?</p>
            ...
            <div class="header">
					<div class="footer">
						<div class="body">
							...
							<h1><center>THANK YOU FOR ORDERING WITH US AND VIEWING OUR WEBISTE</center></h1>
							<br><br><br><br>
							<br><br><br><br>
							<br><br><br><br>
							<h1><center>VISIT US AGAIN!!</center></h1>
